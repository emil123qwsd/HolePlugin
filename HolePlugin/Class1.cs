...
namespace HolePlugin
{
    ...
    public class AddHole : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements) 
        {
            ...
            Document pipDoc = arDoc.Application.Documents.OfType<Document>().Where(x => x.Title.Contains("ТР")).FirstOrDefault();
            if (ovDoc==null)
            {
            ...
            if (pipDoc == null)
            {
                TaskDialog.Show("Ошибка", "Не найден ТР файл");
                return Result.Cancelled;
            }
            ...
            List<Duct> ducts = new FilteredElementCollector(ovDoc)
                ...
                .OfType<Duct>()
                .ToList();
            List<Pipe> pipes = new FilteredElementCollector(pipDoc)
                .OfClass(typeof(Pipe))
                .OfType<Pipe>()
                .ToList();
            ...
            transaction2.Start("Расстановка отверстий 2");
